...
class SellerForm extends StatefulWidget {
  ...
  SellerForm({required this.email});
...
class _SellerFormState extends State<SellerForm> {
  ...
  final databaseRef = FirebaseDatabase.instance.ref("sellers");
  ...
  Future<void> _submitForm() async {
    if (_formKey.currentState!.validate()) {
      ...
      await databaseRef.push().set({
        ...
        'latitude': currentLatitude, // Add current latitude
        'longitude': currentLongitude, // Add current longitude
      });
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: Text('Seller Request Form')),
          ...
          child: Form(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed:
                      isLoading ? null : _submitForm, // Disable when loading
                  child: isLoading
